...
def run(numberOfDecisionVariables, problem, problem_np, comp_file, print_igd, print_x, print_y, show_graph):
    ...
    m6 = M6(problem=problem, problem_np=problem_np, sample_size=300, SEmax=500, EMO=mrga, kktpm=KKTPM(), R=R)
    my_front = m6.run()
