...
#         # self.termination = DefaultMultiObjectiveTermination() Não preciso
#         # self.tournament_type = 'comp_by_dom_and_crowding' ja temos o selection
...
class My_NSGAII(Algorithm):
    ...
    def __init__(self,
                 ...
                 crossover=SBXCrossover(probability=0.9, distributionIndex=15),
                 mutation=PolynomialMutation(probability=0.1, distributionIndex=20),
                 selection=BinaryTournament(),
                 sparsity=CrowdingDistance()):
        
        super(My_NSGAII, self).__init__(
            problem=problem,
